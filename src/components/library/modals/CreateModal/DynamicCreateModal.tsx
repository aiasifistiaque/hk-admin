...
import FormMainV2 from '../../create-page/page/form-components/FormMainV2';
...
const DynamicCreateModal = (props: CreateServerModalProps) => {
	const {
		trigger,
		path,
		title,
			...
			<Dialog
				...
				<form
					...
					<DialogBody>
						...
						{/* <JsonView data={populate} />
						<JsonView data={formData} />
						<JsonView data={changedData} /> */}
